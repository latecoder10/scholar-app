...
export default function MobileAppHub({ questions = [] }: MobileAppHubProps) {
  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      {/* Hero */}
      <div className="relative overflow-hidden bg-gradient-to-br from-indigo-50 via-white to-purple-50 border border-slate-100 rounded-2xl p-6 md:p-10">
        <div className="pointer-events-none absolute -top-20 -right-16 w-72 h-72 bg-indigo-200/40 rounded-full blur-3xl" />
        <div className="pointer-events-none absolute -bottom-24 -left-16 w-72 h-72 bg-purple-200/40 rounded-full blur-3xl" />
        ...
        <div className="relative flex flex-col lg:flex-row items-center gap-10">
          <div className="flex-1 max-w-xl">
            ...
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight leading-tight">
              <span className="text-slate-900">Exam Scholar, </span>
              <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">in your pocket.</span>
            </h1>
            <p className="text-slate-500 text-sm md:text-base mt-3 leading-relaxed">
              One curriculum, every device. All <strong className="text-slate-700">{TOTAL_COUNT.toLocaleString()} questions</strong> ({CCAF_COUNT.toLocaleString()} Claude CCAF, {CIL_COUNT.toLocaleString()} CIL MT) bundled on-device — 100% offline, with the same UI and Exam Tricks as the web app.
            </p>

            {/* Feature pills */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 mt-6">
              {HERO_FEATURES.map((f) => (
                <div key={f.title} className="bg-white border border-slate-100 rounded-xl px-3 py-2.5 flex items-center gap-2 shadow-sm">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-6">
              <a
                ...
                className="px-5 py-3.5 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-semibold text-sm flex items-center gap-2.5 transition-colors"
              >
              ...
              <button
                ...
                className="px-5 py-3.5 bg-slate-900 hover:bg-slate-800 text-white rounded-xl font-semibold text-sm flex items-center gap-2.5 transition-colors"
              >
